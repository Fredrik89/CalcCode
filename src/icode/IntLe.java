...
public class IntLe extends BoolOpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntLe clone() throws CloneNotSupportedException {
        IntLe node = (IntLe)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public IntLe copy() {
      try {
          IntLe node = (IntLe)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntLe fullCopy() {
        IntLe res = (IntLe)copy();
    ...
    // Declared in icodeToString.jadd at line 88

    String opString() {return "INTLE";}
    ...
    // Declared in icode.ast line 31
    public IntLe(Operand p0, Operand p1, Address p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
