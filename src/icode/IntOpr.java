...
public abstract class IntOpr extends BinOpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntOpr clone() throws CloneNotSupportedException {
        IntOpr node = (IntOpr)super.clone();
        return node;
    }
    // Declared in icode.ast at line 3
    // Declared in icode.ast line 22
    ...
    // Declared in icode.ast line 22
    public IntOpr(Operand p0, Operand p1, Address p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
