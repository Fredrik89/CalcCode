...
public class IntEq extends BoolOpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntEq clone() throws CloneNotSupportedException {
        IntEq node = (IntEq)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public IntEq copy() {
      try {
          IntEq node = (IntEq)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntEq fullCopy() {
        IntEq res = (IntEq)copy();
    ...
    // Declared in icodeToString.jadd at line 85

    String opString() {return "INTEQ";}

    // Declared in icode.ast at line 3
    // Declared in icode.ast line 28
    ...
    // Declared in icode.ast line 28
    public IntEq(Operand p0, Operand p1, Address p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
