...
public class IntDiv extends IntOpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntDiv clone() throws CloneNotSupportedException {
        IntDiv node = (IntDiv)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public IntDiv copy() {
      try {
          IntDiv node = (IntDiv)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntDiv fullCopy() {
        IntDiv res = (IntDiv)copy();
    ...
    // Declared in icodeToString.jadd at line 84

    String opString() {return "INTDIV";}
    ...
    // Declared in icode.ast line 29
    public IntDiv(Operand p0, Operand p1, Address p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
