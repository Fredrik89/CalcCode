...
public class IntAdd extends IntOpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntAdd clone() throws CloneNotSupportedException {
        IntAdd node = (IntAdd)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public IntAdd copy() {
      try {
          IntAdd node = (IntAdd)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntAdd fullCopy() {
        IntAdd res = (IntAdd)copy();
    ...
    // Declared in icodeToString.jadd at line 81
