...
public class IntLt extends BoolOpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntLt clone() throws CloneNotSupportedException {
        IntLt node = (IntLt)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public IntLt copy() {
      try {
          IntLt node = (IntLt)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public IntLt fullCopy() {
        IntLt res = (IntLt)copy();
    ...
    // Declared in icodeToString.jadd at line 87

    String opString() {return "INTLT";}
    ...
    // Declared in icode.ast line 30
    public IntLt(Operand p0, Operand p1, Address p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
