...
public class Lt extends BinExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Lt clone() throws CloneNotSupportedException {
        Lt node = (Lt)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Lt copy() {
      try {
          Lt node = (Lt)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Lt fullCopy() {
        Lt res = (Lt)copy();
    ...
    // Declared in Parser.ast line 20
