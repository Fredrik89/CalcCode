...
public class Add extends BinExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Add clone() throws CloneNotSupportedException {
        Add node = (Add)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Add copy() {
      try {
          Add node = (Add)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Add fullCopy() {
        Add res = (Add)copy();
    ...
    // Declared in Parser.ast line 17
