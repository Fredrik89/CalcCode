...
public class Neq extends BinExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Neq clone() throws CloneNotSupportedException {
        Neq node = (Neq)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Neq copy() {
      try {
          Neq node = (Neq)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Neq fullCopy() {
        Neq res = (Neq)copy();
    ...
    // Declared in Parser.ast line 25
