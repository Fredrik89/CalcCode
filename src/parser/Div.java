...
public class Div extends BinExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Div clone() throws CloneNotSupportedException {
        Div node = (Div)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Div copy() {
      try {
          Div node = (Div)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Div fullCopy() {
        Div res = (Div)copy();
    ...
    // Declared in Parser.ast line 19
