...
public class Param extends IdDecl implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Param clone() throws CloneNotSupportedException {
        Param node = (Param)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Param copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Param fullCopy() {
        Param res = (Param)copy();
    ...
    // Declared in Parser.ast line 7
    public Param(Type p0, Id p1, Opt<Expr> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
