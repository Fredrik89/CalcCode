...
public class Lte extends BinExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Lte clone() throws CloneNotSupportedException {
        Lte node = (Lte)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Lte copy() {
      try {
          Lte node = (Lte)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Lte fullCopy() {
        Lte res = (Lte)copy();
    ...
    // Declared in Parser.ast line 22
