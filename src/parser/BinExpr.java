...
public abstract class BinExpr extends Expr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public BinExpr clone() throws CloneNotSupportedException {
    ...
    public BinExpr(int i) {
        super(i);
    }

    // Declared in Parser.ast at line 6

    public BinExpr(Parser p, int i) {
        this(i);
        parser = p;
    }
    ...
    public void dumpTree(String indent, java.io.PrintStream pStream) {
        pStream.println(indent + "BinExpr");
