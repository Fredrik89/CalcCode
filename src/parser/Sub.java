...
public class Sub extends BinExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Sub clone() throws CloneNotSupportedException {
        Sub node = (Sub)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Sub copy() {
      try {
          Sub node = (Sub)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Sub fullCopy() {
        Sub res = (Sub)copy();
    ...
    // Declared in Parser.ast line 18
