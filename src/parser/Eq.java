...
public class Eq extends BinExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Eq clone() throws CloneNotSupportedException {
        Eq node = (Eq)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Eq copy() {
      try {
          Eq node = (Eq)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Eq fullCopy() {
        Eq res = (Eq)copy();
    ...
    // Declared in Parser.ast line 24
