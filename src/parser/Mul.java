...
public class Mul extends BinExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Mul clone() throws CloneNotSupportedException {
        Mul node = (Mul)super.clone();
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Mul copy() {
      try {
          Mul node = (Mul)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Mul fullCopy() {
        Mul res = (Mul)copy();
    ...
    // Declared in Parser.ast line 16
